...
(function(){
    ...
    var MarkerClusterer =
        ...
        BMapLib.MarkerClusterer = function(map, options){
            ...
            this._name = opts['name'] || "共有";
            this._boundaries = opts['boundaries'];//片区边界
    ...
    MarkerClusterer.prototype._addToClosestCluster = function (marker){
        ...
        for(var i = 0, cluster; cluster = this._clusters[i]; i++){
            ...
            if(center){
                ...
                // }
                if(BMapLib.GeoUtils.isPointInPolygon(position, cluster._bounds)){
                    clusterToAddTo = cluster;
                }
            }
        }
        if (clusterToAddTo){
            ...
            //单个标记
            for(var i in this._boundaries){
                if(BMapLib.GeoUtils.isPointInPolygon(position, this._boundaries[i])){
                    var cluster = new Cluster(this);
                    cluster.addMarker(marker);
                    cluster.setBounds(this._boundaries[i]);
    ...
    function Cluster(markerClusterer){
        ...
        this._labels = [];
        this._clusterMarker = new BMapLib.TextIconOverlay(this._center, {name:this._markerClusterer._name,value : this._markers.length}, {"styles":this._markerClusterer.getStyles()});
        //this._map.addOverlay(this._clusterMarker);
        this._bounds = null;//边界
    }
    ...
    Cluster.prototype.setBounds = function(bounds){
        this._bounds = bounds;
    }
    ...
    Cluster.prototype.addLabel = function (marker) {
        ...
        var content = '<span style="color:'+this._styles[0].backgroundColor+'" title="'+marker.getTitle()+'"><i class="fa fa-map-marker"></i></span>'
                    + '<a href="'+marker.url+'"><p style="padding:0px 13px;text-align:center;margin-top:5px;cursor:pointer;">'+marker.getTitle()+'</p></a>';
        ...
        label.addEventListener('mouseover', function(e){
            ...
            e.target.getMap().addOverlay(e.target);
        });
    ...
    Cluster.prototype.updateClusterMarker = function () {
        ...
        this._clusterMarker.setText({name : this._markerClusterer._name , value : this._markers.length});
